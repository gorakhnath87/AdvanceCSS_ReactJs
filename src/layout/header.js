...
class Header extends React.Component {
    ...
    render() {
        ...
        return ( <
            ...
            <
            div className = {
                "header " + (!this.state.visible ? "header__hidden" : null)
            } >
            <
            img src = {
                logo
            ...
            <
            a className = {
                isServiceSelected ? "dropDownMenu__service" : ""
            } > service < /a> <
            div className = "dropDownMenu__content hideSubMenu" >
            <
            NavLink className = "dropDownMenu__content--link"
            to = "/software"
            exact = {
                true
            } > Software < /NavLink> <
            ...
            <
            div className = {
                !this.state.visible ? "header__Scroll" : null
            }
            style = {
                {
